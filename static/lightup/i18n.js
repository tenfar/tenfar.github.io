  ...
  var DICTS = {
    'zh-Hant': {
      ...
      support: {
        ...
        q4: '有廣告或內購嗎？',
        a4: '沒有廣告、沒有追蹤。內購僅用於解鎖「開燈 Pro」（數學永久免費，語文與英語為 Pro 內容）。',
        q5: '怎麼安裝「開燈」？',
    ...
    en: {
      privacy: {
        ...
        li5: 'In-app purchases only unlock "LightUp Pro" (math stays free forever; Chinese & English are Pro content)',
      ...
      support: {
        ...
        a4: 'No ads, no tracking. In-app purchases only unlock "LightUp Pro" (math stays free forever; Chinese & English are Pro content).',
