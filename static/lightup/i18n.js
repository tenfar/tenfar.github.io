/* LightsUp public site i18n — shared engine + page dictionaries.
...
(function () {
  ...
  var DICTS = {
    'zh-Hant': {
      privacy: {
        __title: '開燈 LightsUp · 隱私政策',
        __desc: '開燈 LightsUp 隱私政策：不收集任何用戶資料，所有資料僅保存在裝置本機。',
        h1: '開燈 LightsUp 隱私政策',
        meta: '生效日期：2026 年 9 月 18 日 · 版本 v1.2 · 開發者：Tenfar Lin',
        lead: '<strong>「開燈 LightsUp」不收集任何用戶資料。</strong>App Store 隱私標籤為「不收集資料」。本頁用平實的語言說明這款應用程式如何對待你和孩子的資料。',
        h_notdo: '我們不做的事',
        ...
        li5: '內購僅用於解鎖「開燈 Pro」（數學永久免費，語文與英語為 Pro 內容）',
        ...
        h_child: '兒童私隱',
        p_child: '「開燈」面向 3–9 歲兒童及其家長設計。我們對所有年齡段的用戶一視同仁：不收集任何人的任何資料，兒童亦然。家長移除應用程式，即可刪除全部本地資料。',
        h_perm: '權限一覽',
        p_perm: '本應用僅申請「麥克風」一項權限，用途見上文；不申請通訊錄、照片、位置等任何其他權限。',
        h_future: '關於未來的聯網功能',
        p_f0: '現版本不向任何伺服器發起網絡請求。「AI 變式題」由 Apple 裝置端模型在裝置上生成，全程不出裝置；家長自帶 API 金鑰的雲端 AI 為預留路徑，首發未開放。未來版本若開放，資料去向如下：',
        p_f1: '<strong>完全可選、預設不可見</strong>：僅當家長在設定中自行填入第三方 AI 服務的 API 金鑰後，雲端路徑才會出現；不設定，應用就與現在完全一樣，零聯網。',
        ...
        footer: '© 2026 開燈 LightsUp · <a href="./support.html">支援與常見問題</a>'
      },
      support: {
        __title: '開燈 LightsUp · 支援與常見問題',
        __desc: '開燈 LightsUp 支援頁：聯絡方式與常見問題。',
        h1: '開燈 LightsUp · 支援與常見問題',
        meta: '更新日期：2026 年 9 月 18 日',
        ...
        q4: '有廣告或內購嗎？',
        a4: '沒有廣告、沒有追蹤。內購僅用於解鎖「開燈 Pro」：數學永久免費，語文與英語為 Pro 內容（年費享 7 天免費試用、隨時取消，支援家人共享）。',
        q5: '怎麼安裝「開燈」？',
        a5: '「開燈」正在內測：可<a href="https://testflight.apple.com/join/jCXSHnXJ">透過 TestFlight 參與公測</a>（需 Apple ID，名額有限）。App Store 上架準備中，屆時將在除中國大陸外的 App Store 地區提供（含香港、台灣、新加坡、馬來西亞、泰國等）。',
        q6: '跟讀沒有聲音 / 無法錄音？',
        a6: '請依次檢查：系統「設定 → 開燈」中麥克風權限是否開啟；裝置的音量與靜音開關；重新啟動應用再試。仍然不行請電郵聯絡我們，並附上機型與系統版本。',
        footer: '© 2026 開燈 LightsUp · <a href="./privacy.html">私隱政策</a>'
      },
      home: {
        __title: '開燈 LightsUp · 孩子卡在哪裡，開燈照給你看',
        __desc: '開燈 LightsUp：數學/語文/英語三學科微觀盲點診斷、每日 3 分鐘靶向練習、60 秒點亮挑戰、光點與勳章。數據全在本機，不收集任何資料。',
        eyebrow: '數學 · 語文 · 英語',
        h1: '孩子卡在哪裡，開燈照給你看',
        ...
        c4_m7: '燈火通明',
        c4_m8: '長明燈',
        /* store-parity highlights + TestFlight CTA (LIG-802, from ASC listing) */
        hl1t: '跟著學校教中文',
        hl1p: '簡體／繁體、拼音／注音／粵拼，粵語／普通話朗讀；繁體寫字有正確筆順描紅。',
        hl2t: '多孩家庭',
        hl2p: '每個孩子獨立檔案：知識樹進度、練習記錄、光點、勳章完全獨立。',
        hl3t: '內容與解鎖',
        hl3p: '內建數學小一至小三、科學（常識）小一至小二、語文拼音＋識字（按年級檔位逐步解鎖，最高 2000 字）、英語 E1–E6 起步包。數學永久免費；語文、科學與英語隨 Pro 解鎖（年費享 7 天免費試用、家人共享）。',
        hl4t: '為 3–9 歲設計',
        hl4p: '家長視圖長按解鎖，孩子亂點打不開；無廣告、無排名，光點只增不減。',
        gett: '現在就能用上',
        getp: 'TestFlight 公測進行中，歡迎加入；App Store 上架準備中，屆時將在除中國大陸外的 App Store 地區提供。',
        getcta: '透過 TestFlight 參與公測',
        getsoon: 'App Store · 上架準備中',
        priv: '數據全在本機 · 不收集任何資料',
        privl: '隱私政策 ›',
        footer: '© 2026 開燈 LightsUp · <a href="./privacy.html">隱私政策</a> · <a href="./support.html">支持與常見問題</a>'
      },
      landing: {
        __title: '開燈 LightsUp · 全量 Mock UI（35 Screens）',
        ...
        footer: '© 2026 開燈 LightsUp<span style="margin:0 12px;color:var(--matcha-l)">·</span><a href="./privacy.html" style="color:var(--matcha);text-decoration:none">私隱政策</a><span style="margin:0 12px;color:var(--matcha-l)">·</span><a href="./support.html" style="color:var(--matcha);text-decoration:none">支援與常見問題</a>',
    ...
    en: {
      privacy: {
        __title: 'LightsUp · Privacy Policy',
        __desc: 'LightsUp privacy policy: no user data is collected; everything stays on your device.',
        h1: 'LightsUp (开灯) Privacy Policy',
        meta: 'Effective date: September 18, 2026 · Version v1.2 · Developer: Tenfar Lin',
        lead: '<strong>LightsUp does not collect any user data.</strong> Our App Store privacy label is "Data Not Collected". This page explains in plain language how the app treats your child\'s data and yours.',
        ...
        li5: 'In-app purchases only unlock "LightsUp Pro" (math stays free forever; Chinese & English are Pro content)',
        ...
        p_child: 'LightsUp is designed for children aged 3–9 and their parents. We treat every user the same at every age: no data is collected from anyone, children included. A parent deleting the app deletes all local data.',
        ...
        p_f0: 'The current version makes no network requests to any server. "AI variant questions" are generated on-device by Apple\'s on-device model and never leave the device; a parent-supplied-API-key cloud path is reserved but not open at launch. If a future version opens it, here is exactly where the data would go:',
        p_f1: '<strong>Fully optional, invisible by default</strong>: the cloud path would only appear after a parent enters their own API key for a third-party AI service in Settings. Without it, the app behaves exactly as it is today — zero networking.',
        ...
        footer: '© 2026 LightsUp (开灯) · <a href="./support.html">Support & FAQ</a>'
      },
      support: {
        __title: 'LightsUp · Support & FAQ',
        __desc: 'LightsUp support page: how to contact us and frequently asked questions.',
        h1: 'LightsUp · Support & FAQ',
        meta: 'Updated: September 18, 2026',
        ...
        a2: 'No. LightsUp has no accounts — just open and use it.',
        ...
        a4: 'No ads, no tracking. In-app purchases only unlock "LightsUp Pro": math stays free forever; Chinese & English are Pro content (the yearly plan includes a 7-day free trial, cancel anytime, Family Sharing supported).',
        q5: 'How do I install LightsUp?',
        a5: 'LightsUp is in beta: join via <a href="https://testflight.apple.com/join/jCXSHnXJ">TestFlight</a> (Apple ID required, limited seats). An App Store release is in preparation and will be available in all App Store territories except mainland China (including Hong Kong, Taiwan, Singapore, Malaysia, and Thailand).',
        q6: 'No sound on read-aloud / recording not working?',
        a6: 'Check in order: microphone permission under system Settings → LightsUp; device volume and the mute switch; then restart the app. If it still fails, email us with your device model and OS version.',
        footer: '© 2026 LightsUp (开灯) · <a href="./privacy.html">Privacy Policy</a>'
      },
      home: {
        __title: 'LightsUp · Where your child gets stuck, LightsUp shows you',
        __desc: 'LightsUp: micro-level blind spot diagnosis across Math / Chinese / English, a 3-minute targeted practice each day, a 60-second Light-Up Challenge, points and medals. All data stays on the device — nothing collected.',
        eyebrow: 'Math · Chinese · English',
        h1: 'Where your child gets stuck,<br>LightsUp shows you.',
        ...
        c4_m8: 'Eternal Lamp',
        /* store-parity highlights + TestFlight CTA (LIG-802, from ASC listing) */
        hl1t: 'Chinese, the way school teaches it',
        hl1p: 'Simplified or traditional characters, Pinyin/Zhuyin/Jyutping, Cantonese or Mandarin read-aloud; traditional writing practice has correct stroke-order tracing.',
        hl2t: 'Multiple kids',
        hl2p: 'Each child gets their own profile: knowledge-tree progress, practice history, points and badges stay fully separate.',
        hl3t: 'What’s included',
        hl3p: 'Grade 1–3 math, P1–P2 science (General Studies), Chinese pinyin + literacy that unlocks by grade and tier (up to 2,000 characters), English E1–E6 starter pack. Math is free forever; Chinese, science and English unlock with Pro (yearly plan includes a 7-day free trial, Family Sharing supported).',
        hl4t: 'Built for ages 3–9',
        hl4p: 'The parent view needs a long-press to unlock, so random kid taps can’t get in. No ads, no rankings — points only go up.',
        gett: 'Get it today',
        getp: 'The TestFlight beta is open — tap to join. An App Store release is in preparation and will be available everywhere except mainland China.',
        getcta: 'Join the TestFlight beta',
        getsoon: 'App Store · coming soon',
        priv: 'All data on-device · Nothing collected',
        privl: 'Privacy Policy ›',
        footer: '© 2026 LightsUp (开灯) · <a href="./privacy.html">Privacy Policy</a> · <a href="./support.html">Support & FAQ</a>'
      },
      landing: {
        __title: 'LightsUp · Complete UI Mock (35 Screens)',
        live: 'Math · Chinese · English · 60s Rush · Points & Medals',
        eyebrow: 'Complete UI Mock · All Screens',
        h1: 'Where your child gets stuck,<br><em>LightsUp</em> shows you.',
        ...
        footer: '© 2026 LightsUp (开灯)<span style="margin:0 12px;color:var(--matcha-l)">·</span><a href="./privacy.html" style="color:var(--matcha);text-decoration:none">Privacy Policy</a><span style="margin:0 12px;color:var(--matcha-l)">·</span><a href="./support.html" style="color:var(--matcha);text-decoration:none">Support & FAQ</a>',
