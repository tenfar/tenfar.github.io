  ...
  var DICTS = {
    'zh-Hant': {
      ...
      home: {
        ...
        hl3t: '內容與解鎖',
        hl3p: '內建數學 P1、語文拼音＋識字 300、英語 E1–E6 起步包。數學永久免費；語文與英語隨 Pro 解鎖（年費享 7 天免費試用、家人共享）。',
        hl4t: '為 3–9 歲設計',
    ...
    en: {
      ...
      home: {
        ...
        hl3p: 'Grade-1 math, Chinese pinyin + 300 characters, English E1–E6 starter pack. Math is free forever; Chinese and English unlock with Pro (yearly plan includes a 7-day free trial, Family Sharing supported).',
